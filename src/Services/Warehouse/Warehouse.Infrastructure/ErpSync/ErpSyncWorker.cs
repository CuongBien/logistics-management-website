...
public class ErpSyncWorker : BackgroundService
{
    ...
    private async Task SyncSkusAsync(string tenantId, WMSDbContext dbContext, IErpMasterDataClient erpClient, CancellationToken cancellationToken)
    {
    ...
    private async Task SyncWarehousesAsync(string tenantId, WMSDbContext dbContext, IErpMasterDataClient erpClient, CancellationToken cancellationToken)
    {
