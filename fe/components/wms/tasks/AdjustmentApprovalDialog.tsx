      ...
      <DialogContent className="sm:max-w-[460px] bg-card border border-muted shadow-2xl rounded-2xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-foreground font-extrabold text-lg">
            ...
            Xét Duyệt Kết Quả Kiểm Kho
          </DialogTitle>
          <DialogDescription className="text-muted-foreground text-xs mt-1">
            Đánh giá kết quả kiểm đếm thực tế của nhân viên và đưa ra phán quyết điều chỉnh số liệu hệ thống cho tác vụ <span className="font-mono font-bold text-primary">{task.id}</span>.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-3.5 my-2">
          ...
          <div className="bg-rose-500/5 border border-rose-500/10 p-4 rounded-xl space-y-3">
            ...
            <div className="border-t border-rose-500/10 pt-2.5 flex items-center justify-between">
          ...
          {/* Supervisor Decision Notes Input */}
